...
//        }
        ...
        for (int i = 0; i < itemtypelist.size(); i++) {
            int itemquality = (int) itemtypelist.get(i).itemStats.getProperty("quality");
        ...
        if ((int) stats.itemStats.getProperty("itemclass") != 0) {
    ...
    private static Item addAttributes(Item item, int droplevel) {
        ...
        for (int i = 0; i < attributesofrightclass.size(); i++) {
            ...
            double test = attributesofrightclass.get(i).itemStats.getProperty("quality");
            if (test <= droplevel) {
