...
public class ItemAttributeTypes {
    ...
    public ItemAttributeTypes() {
        ...
        weaponattributelist.add(new ItemAttributeWeapon("Even More Attackspeed", 1, 0.0f, 0.5f, 0.0f));
        weaponattributelist.add(new ItemAttributeWeapon("More Range", 1, 0.0f, 0.0f, 0.2f));
        ...
        armorattributelist.add(new ItemAttributeArmor("Even More Armor", 1, 0.5f, 0.0f));
        armorattributelist.add(new ItemAttributeArmor("More Movespeed", 1, 0.0f, 0.1f));
        armorattributelist.add(new ItemAttributeArmor("Unusual", 2, 0.0f, 0.1f));
    }
