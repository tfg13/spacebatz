...
public class ItemAttributeTypes {
    ...
    public ItemAttributeTypes() {
        ...
        moreDamage.setItemProperty("quality", 1.0);
        moreDamage.setBonusProperty("damagemultiplicator", 0.1);
        attributelist.add(moreDamage);

        ItemAttribute evenMoreDamage = new ItemAttribute("Even More Damage");
        evenMoreDamage.setItemProperty("quality", 2.0);
        evenMoreDamage.setBonusProperty("damagemultiplicator", 0.3);
        attributelist.add(evenMoreDamage);

        ItemAttribute moreAttackSpeed = new ItemAttribute("More Attackspeed");
        moreAttackSpeed.setItemProperty("quality", 1.0);
        moreAttackSpeed.setBonusProperty("attackspeedmultiplicator", 0.1);
        attributelist.add(moreAttackSpeed);

        ItemAttribute evenMoreAttackSpeed = new ItemAttribute("Even More Attackspeed");
        evenMoreAttackSpeed.setItemProperty("quality", 2.0);
        evenMoreAttackSpeed.setBonusProperty("attackspeedmultiplicator", 0.3);
        attributelist.add(evenMoreAttackSpeed);

        ItemAttribute moreRange = new ItemAttribute("More Range");
        moreRange.setItemProperty("quality", 2.0);
        moreRange.setBonusProperty("rangemultiplicator", 0.2);
        attributelist.add(moreRange);

        ItemAttribute moreEverything = new ItemAttribute("More Everything");
        moreEverything.setItemProperty("quality", 3.0);
        moreEverything.setBonusProperty("damage", 0.1);
        moreEverything.setBonusProperty("attackspeed", 0.1);
        moreEverything.setBonusProperty("rangemultiplicator", 0.1);
        attributelist.add(moreEverything);

        ItemAttribute moreArmor = new ItemAttribute("More Armor");
        moreArmor.setItemProperty("quality", 1.0);
        ...
        evenMoreArmor.setItemProperty("quality", 2.0);
        ...
        moreHP.setItemProperty("quality", 1.0);
        ...
        moreMovespeed.setItemProperty("quality", 2.0);
        ...
        unusual.setItemProperty("quality", 2.0);
