...
public class ItemAttributeTypes {
    ...
    public ItemAttributeTypes() {
        ...
        moreDamage.setWeaponProperty("damagemultiplicator", 0.2);
        ...
        evenMoreDamage.setWeaponProperty("damagemultiplicator", 0.5);
        ...
        moreAttackSpeed.setWeaponProperty("attackspeedmultiplicator", 0.2);
        ...
        evenMoreAttackSpeed.setWeaponProperty("attackspeedmultiplicator", 0.5);
        ...
        moreRange.setWeaponProperty("rangemultiplicator", 0.3);
        ...
        moreEverything.setWeaponProperty("damage", 0.2);
        moreEverything.setWeaponProperty("attackspeed", 0.2);
        ...
        moreArmor.setBonusProperty("armormultiplicator", 0.2);
        ...
        evenMoreArmor.setBonusProperty("armormultiplicator", 0.5);
