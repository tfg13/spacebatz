...
public class ItemTypes {
    ...
    public ItemTypes() {
        ...
        pistol.setQuality(1);
        pistol.setAmount(0);
        pistol.setWeaponAbility(new FireBulletAbility(7, 0.067, 10.0, 1, 0.35, 0.05, 0.0, 0, 0));
        ...
        superlaser.setWeaponAbility(new FireBulletAbility(25, 0.04, 12.0, 2, 0.5, 0.02, 0.0, 3, 0.01));
        ...
        rocketlauncher.setWeaponAbility(new FireBulletAbility(20, 0.025, 15.0, 4, 0.25, 0.0, 6.0, 3, 0.01));
        ...
        superrocketlauncher.setWeaponAbility(new FireBulletAbility(12, 0.08, 15.0, 4, 0.35, 0.0, 4.0, 12, 0.025));
        ...
        superpistol.setWeaponAbility(new FireBulletAbility(12, 0.1, 12.0, 1, 0.35, 0.02, 0.0, 0, 0));
