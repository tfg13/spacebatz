...
public class ItemTypes {
    ...
    public ItemTypes() {
        ...
        laser.setQuality(1);
        laser.setAmount(0);
        laser.setWeaponAbility(new FireBulletAbility(4, 6.0, 9.0, 3, 0.35, 0.1, 0.0, 20, 0.025));
        ...
        superlaser.setWeaponAbility(new FireBulletAbility(25, 25.0, 12.0, 2, 0.5, 0.02, 0.0, 3, 0.01));
        ...
        rocketlauncher.setWeaponAbility(new FireBulletAbility(20, 40.0, 15.0, 4, 0.25, 0.0, 6.0, 3, 0.01));
        ...
        drill.setQuality(1);
        drill.setAmount(0);
        drill.setWeaponAbility(new HitscanAbility(50, 60.0, 4.0, 5, 0.01));
        ...
        saw.setQuality(1);
        saw.setAmount(0);
        saw.setWeaponAbility(new HitscanAbility(15, 12.0, 4.0, 10, 0.02));
