...
public class ItemTypes {
    ...
    public ItemTypes() {
        ...
        ItemTypeWeaponStats pistol = new ItemTypeWeaponStats(3, 15.0, 10.0, 0, 0, 0.35, 0.025, 0.0);
        itemtypelist.add(new ItemTypeStats("Pistol", 4, 1, 1, 0, 0, pistol));

        ItemTypeWeaponStats laser = new ItemTypeWeaponStats(4, 6.0, 9.0, 0, 0, 0.35, 0.1, 0.0);
        itemtypelist.add(new ItemTypeStats("Laser", 2, 1, 2, 0, 0, laser));

        ItemTypeWeaponStats superlaser = new ItemTypeWeaponStats(25, 25.0, 12.0, 0, 0, 0.5, 0.02, 0.0);
        itemtypelist.add(new ItemTypeStats("Super Laser", 3, 1, 3, 0, 0, superlaser));

        ItemTypeWeaponStats rocketlauncher = new ItemTypeWeaponStats(30, 40.0, 15.0, 0, 0, 0.25, 0.0, 4.0);
