...
public class STC_SWITCH_WEAPON extends FixedSizeSTCCommand {
    ...
    public static void sendWeaponswitch(Client client, byte slot) {
        ...
        for (Client c : Server.game.clients.values()) {
            //Server.serverNetwork.sendTcpData(MessageIDs.NET_TCP_CMD_SWITCH_WEAPON, b, c);
            Server.serverNetwork2.queueOutgoingCommand(new OutgoingCommand(MessageIDs.NET_TCP_CMD_SWITCH_WEAPON, b), c);
