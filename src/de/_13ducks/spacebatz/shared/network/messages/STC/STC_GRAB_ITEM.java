...
public class STC_GRAB_ITEM extends FixedSizeSTCCommand {
    ...
    public static void sendItemGrab(int itemnetID, int clientID) {
        for (Client c : Server.game.clients.values()) {
            ...
            //Server.serverNetwork.sendTcpData(MessageIDs.NET_TCP_CMD_GRAB_ITEM, b, c);
            Server.serverNetwork2.queueOutgoingCommand(new OutgoingCommand(MessageIDs.NET_TCP_CMD_GRAB_ITEM, b), c);
        }
    }
}
